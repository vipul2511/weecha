...
import {Text,View,TouchableOpacity, TextInput,Image, NativeModules,ScrollView} from "react-native";
    ...
    return(
        <View style={{flex:1,backgroundColor:'#fff'}}>
            ...
            <TouchableOpacity onPress={()=>{props.navigation.goBack()}} style={{margin:'3%',marginTop:hp('4%'),flexDirection:'row',}}>
                ...
                <Text style={{fontSize:wp('3.9%')}} >Registration / Mobile Number Login:</Text>
                </View>
            </TouchableOpacity>
            <View style={{justifyContent:'center',alignItems:'center',marginTop:hp('4%')}}>
             ...
             <View style={{width:wp('90%'),height:hp('8%'),backgroundColor:'#E8E6F6',paddingLeft:20,borderRadius:100,flexDirection:'row',marginTop:hp('3%')}}>
                 <TextInput value={password} onChangeText={(text)=>{setconfirmPassword(text)}} placeholder={"Password"} placeholderTextColor={"#5B5B5B"} />
             </View>
               <View style={{width:wp('80%'),marginTop:hp('3%')}}>
                   <View style={{justifyContent:'flex-end',alignItems:'flex-end'}}>
                   <Text style={{color:'#4B2FF9',fontSize:wp('3.7')}}>Forgot Password ?</Text>
                   </View>
               </View>
                ...
                <TouchableOpacity onPress={()=>{props.navigation.navigate('Signup')}} style={{backgroundColor:'#E8E6F6',width:wp('79%'),height:hp('7%'),borderRadius:100,justifyContent:'center',alignItems:'center',borderColor:'#F329F8',borderWidth:1}}>
                <Text style={{color:'#5B5B5B',fontSize:wp('4%')}}>Sign up</Text>
                ...
                <Text style={{color:'#000000',fontFamily:'AvenirLTStd-Book'}}>Other login methods</Text>
                </View>
               ...
               <TouchableOpacity onPress={_signIn} style={{width:wp('8%'),height:hp('4%'),marginRight:wp('3%'),justifyContent:'center',alignItems:'center',borderRadius:100}}>
                   <Image source={require('../../Assets/Images/google_icon.png')} style={{width:wp('8%'),height:hp('8%'),resizeMode:'contain'}} />
               </TouchableOpacity>
               <TouchableOpacity onPress={facebookLogin} style={{width:wp('8%'),height:hp('4%'),marginLeft:wp('3%'),justifyContent:'center',alignItems:'center',borderRadius:100}}>
                   <Image source={require('../../Assets/Images/facebook_icon.png')} style={{width:wp('4%'),height:hp('4%'),resizeMode:'contain'}} />
               </TouchableOpacity>
           </View>
                </View>
             </View>
...
const mapStateToProps = (state) => ({
  ...
  const mapDispatchToProps = (dispatch) =>  ({
    ...
    userLogin: (params) => {dispatch(CommonActions.userLogin(params))},
  });
