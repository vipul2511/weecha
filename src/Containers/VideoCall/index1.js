...
const VideoCall = (props) => {
    ...
    const renderContent = () => (
        ...
        ><View style={{height: hp('15%')}}>
            ...
            <TouchableOpacity><FlipCameraIcon /></TouchableOpacity>
            <TouchableOpacity onPress={() => props.navigation.goBack()}><EndCallIcon /></TouchableOpacity>
            </View>
            </View>
            <View style={{width: '95%', alignSelf: 'center',  justifyContent: 'space-between', flexDirection: 'row', height: hp('10%'),alignItems: 'center'}}>
            <TouchableOpacity><ShareGiftsIcon /></TouchableOpacity>
            <TouchableOpacity><SpeakerIcon /></TouchableOpacity>
            <TouchableOpacity><CameraOffIcon /></TouchableOpacity>
            </View>
        </View>
      );
      const renderHeader = () => (
    ...
    return (
        ...
        <View style={{flex: 1}}>
            ...
            <ImageBackground source={require('../../Assets/Images/photo.png')} style={{width: wp('100%'), height: '100%'}}>
